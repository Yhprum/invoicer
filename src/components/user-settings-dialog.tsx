      ...
      <DialogContent className="sm:max-w-[500px]">
        ...
        <div className="grid gap-4 py-4">
          <div className="space-y-2">
            ...
            <Input id="name" value={name} onChange={(e) => setName(e.target.value)} placeholder="Your name or business name" />
          </div>

          <div className="space-y-2">
            <Label htmlFor="address">Your Address</Label>
            <Textarea id="address" value={address} onChange={(e) => setAddress(e.target.value)} placeholder="Your address" rows={3} />
          </div>
